module gitlab.wikimedia.org/repos/toolforge/builds-api
...
require (
	...
	github.com/tektoncd/pipeline v0.59.6
	k8s.io/api v0.34.0
	k8s.io/apimachinery v0.34.0
	k8s.io/client-go v0.34.0
	// Can't upgrade this until https://github.com/tektoncd/pipeline/issues/8969 is fixed
